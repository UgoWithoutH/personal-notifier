            ...
            if all_transactions is not None:
                ...
                if current_month:
                    ...
                    if xirr_value is None:
                        ...
                        # cash_weight/monthly_yield_rate use the already-
                        # computed avg_invested_balance/avg_non_invested_balance
                        # (same figures as the "solde moyen pondéré" Sheet
                        # rows above) instead of the live total_invested
                        # snapshot (fixed 2026-09-11), so this % is exactly
                        # reconstructible from those two Sheet rows. The
