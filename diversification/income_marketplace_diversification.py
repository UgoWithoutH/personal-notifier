    ...
    try:
        with sync_playwright() as p:
            ...
            if all_transactions is not None:
                ...
                # Cash drag now computed for a backfilled month too - only
                # needs the avg balances above (already backfill-aware) and
                # this period's own already-fetched gross_interest_received.
                ...
                if current_month:
                    ...
                    if xirr_value is None:
                        ...
                        # cash_drag_value is now computed earlier
